<?php  include_once ('../../controller/user/seedscontroller.php'); ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <body class="hold-transition skin-green sidebar-mini">
    ...
    <?php   include ('../common/header.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Seeds</a></li>
          ...
          <div class="row">
              <div class="col-xs-12">
                ...
                <div class="box-header">
                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#addseedModal">Add Seed</button>
                </div><!-- /.box-header -->
                <div class="box-body">
    ...
    <!-- ADD SEED MODALS -->
    <div id="addseedModal" class="modal fade" role="dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">                                                           
                    <form role="form" id="addSeedform" enctype="multipart/form-data" onsubmit="return false">
                    <input type="hidden" id="addSeed" name="addSeed" >
                        
                        <div class="form-group">
                            <label for="seednam">Seed:</label>
                            <input type="text" class="form-control" id="seednam" name="seednam" placeholder="Please enter the name of the seed" />
                        </div>
                        <div class="form-group">
                            <label for="seedcode">Code:</label>
                            <input type="text" class="form-control" id="seedcode" name="seedcode" placeholder="Please enter the code of the seed" />
                        </div>
                        <div class="form-group">
                            <label for="seeddesc">seed Description:</label>
                            <textarea class="form-control" id="seeddesc" name="seeddesc"></textarea>
                        </div>                                                
                    </form>
                </div>                            
                <div class="modal-footer">
                    <button class="btn btn-success" onclick="AddSeed()">Save Seed</button>
              ...
              <div class="modal-body">
                  <div id="editseed" class="seedgroup">
                    <form role="form" id="updateSeedform" enctype="multipart/form-data" onsubmit="return false">                        
                        ...
                        <p>edit seed details <span id="actionItem"></span>?</p>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="seedcode1">Code:</label>
                            <input type="text" class="form-control" id="seedcode1" name="seedcode1" placeholder="Please enter the code of the seed" />
                        </div>
                        <div class="form-group">
                  ...
                  <div id="viewseed" class="seedgroup">
                      <p>view seed details <span id="actionItem"></span>?</p>
                      <div class="form-group">
    ...
    <script>
        ...
        $(function() {
            ...
            $(".openModalLink").click(function(e) {
                e.preventDefault();       
                $("#myModalTitle").html('Seed Details');
                $("#viewname").html($(this).data('viewname'));
                $("#viewcode").html($(this).data('viewcode'));
                $("#viewdesc").html($(this).data('viewdesc'));

                $("#seedID").val($(this).data('id'));
                $("#seednam1").val($(this).data('viewname'));
                $("#seedcode1").val($(this).data('viewcode'));
                $("#seeddesc1").val($(this).data('viewdesc'));
        ...
        function AddSeed(){
            _("addSeed").value = "addSeed";        
            _("addSeedform").method = "post";
            _("addSeedform").action = "seeds.php";
            _("addSeedform").submit();
        }
        
        function updateSeed(){                        
            var r = confirm("Are you sure you want to update?");
            if (r) {
                _("updateSeed").value = "updateSeed";        
                _("updateSeedform").method = "post";
                _("updateSeedform").action = "seeds.php";
                _("updateSeedform").submit();
            }
        }
