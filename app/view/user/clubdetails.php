...
<head>
  ...
  <body class="hold-transition skin-green sidebar-mini">
    ...
    <?php include ('../common/header.php');?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Club</a></li>
              ...
              <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                     ...
                     <?php   }
                        ...
                        {
                           foreach($listGacClubs as $value)
                                { 
                                    $ipcid = $value['clubsID'];
                                    $listClubMembers = $districts->listClubMembers($ipcid);
                        ...
                        <td>
                            ...
                            <a  rel="tooltip" title="View more IPC details (Clubs, MEMBERS etc)" class="btn btn-info btn-xs" 
                                href="memberdetails.php?membersdid=<?php echo $value['clubsID'];?>">View more</a>
                            <?php } ?>
                            ...
                            <a rel="tooltip" title="Edit/Update Details" class="btn btn-warning btn-xs openEditIPCModal" href="/" 
                                data-editid="<?php echo $value['clubsID'] ?>"
                                data-editviewitem="5" 
    ...
    <!-- ADD CLUBS -->
    <div id="addClubsModal" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3>ADD Club</h3>
                <form method="post" action="clubdetails.php" enctype="multipart/form-data" class="form-inline center-block">
                    <input type="hidden" id="addIPCBulk" name="addIPCBulk" >
                    <input type="hidden" id="codeitem" name="codeitem" value="5" >
            ...
            <div class="modal-body">                                                                               
                ...
                <input type="hidden" id="codeitem" name="codeitem" value="5" >
                    <input type="hidden" id="refitem" name="refitem" value="<?php echo $id ?>" >
                <table id="exampleLstActivities" class="table table-striped table-bordered tbladdClub" cellspacing="0" width="100%"> 
                    <tr>
                        <th>SELECT</th> 
                        <th>Club Name</th>
                    </tr>
            ...
            <div class="modal-footer">                   
                <button type="button" class='btn btn-danger deleteClub'>- Delete</button>
                <button type="button" class='btn btn-success addmoreClub'>+ Add More</button> 
...
<script src="../../../js/jquery-ui.js"></script>
	...
	check();
        ...
        function AddClub(){           
            ...
            if(checked === true){
                if (window.confirm('are you sure you want to add Clubs?'))
                {                    
                    _("addIPC").value = "addIPC";        
                    _("addClubform").method = "post";
                    _("addClubform").action = "clubdetails.php";
            ...
            if (window.confirm('are you sure you want to Add?'))
                {
                    ...
                    _("addIPCItemsBulkform").action = "clubdetails.php";
