                  ...
                  <table id="example2" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>                       
                     ...
                     <?php   }
                        ...
                        {
                           foreach($lstMembers as $value)
                                {  
                               ?>    
                         <tr> 
                             <td><?php echo $value['names'].' '.$value['surname'] ?></td>
                            ...
                            <td></td>
                            <td>
                                <a rel="tooltip" title="View Profile" class="btn btn-info btn-simple btn-xs" href="memberprofile.php?Sid=<?php echo $value['memberID'];?>">
                                    <i class="fa fa-user"></i></a>
                                <a rel="tooltip" title="Add Member To Registration Year" class="btn btn-info btn-simple btn-xs openModalLink" href="/" data-id="<?php echo $value['memberID'] ?>" >
